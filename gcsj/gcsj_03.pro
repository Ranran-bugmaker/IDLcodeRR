pro gcsj_03
  ...
  path_bulid_pt='R:\PROject_practice\DATA_SHPorETC\ROI\point_building.shp'
...
;  save,datav,FILENAME='R:\PROject_practice\DATA_2csv\data.sav'
  for si = 0L, 2L do begin
    OPENw,lun,csv_path+names[si]+'.csv',/GET_LUN
